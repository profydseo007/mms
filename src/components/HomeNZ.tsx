...
import { COUNTRY_FORM_IDS, COUNTRY_LABELS } from '@/lib/country';
...
export default function HomeNZ() {
  const { navigateTo } = useAppNavigate();
  const [activeFaq, setActiveFaq] = useState<number | null>(null);
  const [formId] = useState(COUNTRY_FORM_IDS.NZ);
  const country = 'NZ';
  ...
  const faqs = [
    {
      ...
      a: 'Every tutor holds a degree in the subject they teach and clears a subject test, a mock lesson and a police vetting check under the Children\'s Act before working with a single student. We also approve tutors by level, because teaching NCEA Level 1 maths well is a different skill from teaching Level 3 Calculus, the standards, the assessment style and the marking expectations all change.'
    },
    {
    ...
    {
      q: 'NCEA is being replaced. What does that actually mean for my child?',
      a: 'The Government has confirmed a phased replacement, and which cohort your child is in decides whether it affects them at all. NCEA Level 1 is removed in 2028 and replaced by a Foundational Award recognising literacy and numeracy at Year 11 level. A new New Zealand Certificate of Education follows for Year 12 in 2029, and a New Zealand Advanced Certificate for Year 13 in 2030. The Ministry has said no student will need to switch between NCEA and the new system partway through their schooling, and that the first cohort to take part is the Year 9 group of 2026. If your child is currently in Year 11, 12 or 13, they finish under NCEA as it stands.'
    },
    {
      q: 'How is the new system graded, and how is that different?',
      a: 'The new qualifications move to a subject-based structure with a six-point grade scale running from A+ to E, replacing the current Not Achieved, Achieved, Merit and Excellence bands. Students study at least five subjects a year and need to pass three to gain the qualification, with an endorsement for passing all five. The practical difference is that credit-by-credit accumulation across unrelated standards goes away, so consistent subject-long performance matters more than assembling credits late in the year.'
    },
    {
      q: 'What is the literacy and numeracy co-requisite?',
      a: 'It is a separate standalone requirement that sits alongside NCEA, and students must meet it to gain the qualification at any level. Credits earned towards the co-requisite cannot also be counted towards the 60 credits needed for NCEA itself, which surprises a lot of families. It is assessed independently of subject standards, so a student can be doing well in class and still not have met it. If your child has not yet passed the numeracy component, that is usually the first thing we address.'
    },
    {
      q: 'Do you help with University Entrance?',
      a: 'Yes. University Entrance requires NCEA Level 3, a set number of credits across approved subjects, and the literacy and numeracy co-requisite. It is entirely possible to gain Level 3 and still miss UE, usually because of the approved-subject rules. We work backwards from the degree your child is aiming at, since some courses carry their own maths or science prerequisites on top of UE.'
    },
    {
      q: 'How much does online tutoring cost in New Zealand?',
      a: 'Rates are billed in New Zealand dollars and depend on subject and year level, with NCEA Level 3 and Scholarship priced above primary and intermediate support. There\'s no registration fee and no minimum contract, and lesson bundles lower the hourly rate. Full pricing is on our pricing page.'
    }
  ];
    ...
    <div>
        ...
        <div className="learning-lane px-margin-mobile grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-max-width mx-auto md:px-margin-desktop">
          <div className="relative z-10 space-y-6">
            ...
            <h1 className="text-display-lg-mobile md:text-display-lg font-display text-charcoal leading-tight font-bold">
              Online Tutoring Services in New Zealand That Actually Click
            </h1>
            <p className="text-body-lg font-sans text-on-surface-variant max-w-lg">
              One-to-one online tutoring in maths, science and English, matched to the New Zealand Curriculum and NCEA.
              We pair your child with a tutor who understands internals and externals, knows how the literacy and numeracy
              co-requisite works, and has the patience to keep going until the concept lands.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-2 sm:-left-6 bg-white p-4 sm:p-6 rounded-2xl shadow-dropdown border border-outline-variant/30 z-20 max-w-[220px] sm:max-w-[280px] min-w-0">
              ...
              <p className="italic text-on-surface-variant text-sm break-words">&quot;She hadn&apos;t passed the numeracy co-requisite and nobody had told us.
                Two terms later it was done, and Level 2 stopped feeling impossible.&quot;</p>
              <p className="mt-3 font-bold text-charcoal text-xs break-words">— Sarah J., Parent from Tauranga</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="learning-lane px-margin-mobile max-w-max-width mx-auto md:px-margin-desktop">
          <div className="text-center mb-16 space-y-3">
            ...
            <p className="text-body-lg text-on-surface-variant">
              ...
              We hire for the first, then match on temperament, because the tutor who suits a student chasing Excellence
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="group flex flex-col items-center text-center p-4">
              ...
              <h3 className="text-headline-md font-display mb-3 text-charcoal font-bold">Standards Expertise</h3>
              <p className="text-body-md text-on-surface-variant leading-relaxed">
                Every tutor holds a degree in their subject and is assessed on the achievement standards your child is marked against,
                across internals and externals. They know how Merit and Excellence are actually awarded, not just the material.
              </p>
            </div>
            {/* Quality 2 */}
            <div className="group flex flex-col items-center text-center p-4">
              ...
              <p className="text-body-md text-on-surface-variant leading-relaxed">
                Most students struggling in Year 12 aren&apos;t stuck on this week&apos;s topic. They&apos;re missing something from Year 9 or 10.
            ...
            <div className="group flex flex-col items-center text-center p-4">
              ...
              <p className="text-body-md text-on-surface-variant leading-relaxed">
                Every tutor is police vetted under the Children&apos;s Act before taking a student. Sessions are recorded to your account,
      ...
      <section className="py-24 bg-soft-gray border-y border-surface-container">
        <div className="learning-lane px-margin-mobile max-w-max-width mx-auto md:px-margin-desktop">
          <div className="text-center mb-16 max-w-2xl mx-auto space-y-4">
            ...
            <h4>An Online Tutoring Platform Built for Kiwi Families</h4>
            <p className="text-body-lg text-on-surface-variant">The teaching is the hard part. Everything around it, booking, rescheduling, paying, tracking progress,
              ...
              And because it&apos;s online, a student in Southland gets the same tutor a student in Remuera does.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              ...
              <p className="text-body-md text-on-surface-variant">See live tutor availability and book around school,
                sport and everything else. No driving across town on a Saturday morning.</p>
            </div>
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
            ...
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              ...
              <p className="text-body-md text-on-surface-variant">Every lesson is saved to your account, so your child can replay an explanation
                the night before an internal and you can see exactly what was covered.</p>
            </div>
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              <Award className="w-8 h-8 text-primary mb-4" />
              <h4 className="text-headline-md font-bold mb-2 text-charcoal">No Locked Contracts</h4>
              <p className="text-body-md text-on-surface-variant">Pay as you go or choose a monthly plan, billed in New Zealand dollars. Cancel anytime, without a fee or a phone call.</p>
            </div>
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              <Star className="w-8 h-8 text-primary mb-4" />
              <h4 className="text-headline-md font-bold mb-2 text-charcoal">Progress Reports</h4>
              <p className="text-body-md text-on-surface-variant">A written summary after every session, plus a fortnightly report showing standards achieved and topics still needing work, in the language of the curriculum.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="learning-lane px-margin-mobile grid grid-cols-1 md:grid-cols-2 gap-12 max-w-max-width mx-auto md:px-margin-desktop">
          ...
          <div className="bg-surface-container-low p-10 rounded-[32px] relative overflow-hidden flex flex-col justify-between border border-surface-container">
            <div className="relative z-10">
              <h3 className="text-headline-lg font-display text-charcoal mb-4 font-semibold">Tutoring From Year 1 to Year 13</h3>
              <p className="text-body-lg text-on-surface-variant mb-8 font-sans">From early numeracy to Year 13 Calculus and Scholarship, our tutors
                teach the curriculum your child&apos;s school actually follows. That includes the years most families overlook,
                Years 9 and 10, where the gaps that later derail NCEA maths quietly open up.</p>
          ...
          <div className="bg-primary p-6 sm:p-10 rounded-[32px] text-white relative overflow-hidden flex flex-col justify-between shadow-lg max-w-full box-border">
            <div className="relative z-10 min-w-0 max-w-full">
              <h3 className="text-headline-lg font-display mb-4 font-semibold text-white break-words">NCEA, University Entrance and Scholarship</h3>
              <p className="text-body-lg text-primary-fixed-dim mb-8 break-words">Exam technique is a separate skill from knowing the material.
                 Our tutors cover assessment schedule strategy, timed external practice, internal preparation, and the
                 subject selection decisions that shape University Entrance long before Year 13. <br></br>Covered: Literacy and numeracy co-requisite · NCEA Levels 1, 2 and 3
                  · Internals and externals · University Entrance · NZQA Scholarship · Subject and pathway planning</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 min-w-0 max-w-full">
                <div className="bg-white/10 p-4 rounded-xl border border-white/20 min-w-0 max-w-full overflow-hidden box-border">
                  <p className="text-[10px] font-bold opacity-80 uppercase tracking-wider min-w-0 break-words">Years 11 to 13</p>
                  <p className="text-headline-md font-bold min-w-0 break-words [overflow-wrap:break-word] [word-break:break-word]">Standards-Matched Tutors</p>
                </div>
                <div className="bg-white/10 p-4 rounded-xl border border-white/20 min-w-0 max-w-full overflow-hidden box-border">
                  <p className="text-[10px] font-bold opacity-80 uppercase tracking-wider min-w-0 break-words">Qualification Change</p>
                  <p className="text-headline-md font-bold min-w-0 break-words [overflow-wrap:break-word] [word-break:break-word]">NCEA and Beyond, Explained</p>
                </div>
              </div>
              <button 
      ...
      <section className="py-24 bg-surface-container-lowest relative overflow-hidden border-y border-surface-container/60">
        ...
        <div className="relative z-10 max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop text-center">
          ...
          <h3 className="font-headline-lg text-headline-lg text-charcoal mb-4 font-semibold">Tutoring Matched to the New Zealand Curriculum</h3>
          <p className="text-body-lg">
            New Zealand runs one national curriculum, and NCEA is administered by NZQA, but what a student needs changes completely
            between Year 9 and Year 13. It is also a system in transition, with NCEA being phased out from 2028. We match tutors by
            year and level as well as subject, so nobody is taught Level 3 technique when what they are actually missing is Year 10 foundations.
             <br></br>
             <strong>Online tutors available nationwide:</strong> Auckland, Wellington, Christchurch, Hamilton, Tauranga, Dunedin and rural Aotearoa.
             <br></br>
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 sm:gap-8">
            {[
              ...
              { name: 'Years 9 and 10 : Where the gaps that later derail NCEA maths quietly open up'},
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
              <div className="text-center group">
                ...
                <p className="text-body-md text-on-surface-variant">Tell us the subject, the year level and what&apos;s going wrong.
              ...
              <div className="text-center group">
                ...
                <p className="text-body-md text-on-surface-variant">We pair your child with a tutor who knows their standards and suits how they learn.
              ...
              <div className="text-center group">
                ...
                <p className="text-body-md text-on-surface-variant">Sessions begin at times you choose. You&apos;ll get written progress after every lesson,
                   and most families notice a shift in confidence well before the next round of internals.</p>
              </div>
            </div>
          </div>
        </div>
