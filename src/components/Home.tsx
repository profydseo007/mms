...
import { COUNTRY_LABELS, COUNTRY_FORM_IDS, getClientCountryDetection } from '@/lib/country';
import { Star, School, Users, CheckCircle, HelpCircle, ArrowRight, BookOpen, Edit, Settings, Shield, Award, Calendar, BookOpenCheck, Globe, MapPin } from 'lucide-react';
...
export default function Home({ onNavigate, country = 'US' }: HomeProps) {
   ...
   const faqs = [
    {
      ...
      a: 'Every tutor holds a degree in the subject they teach and clears a subject test, a mock lesson, and a background check before working with a single student. We also approve tutors per curriculum, so a tutor cleared for SAT math is not automatically cleared for A-Level further math.'
    },
    {
      q: 'Is the free trial really free?',
      a: 'Yes. The first 30-minute session costs nothing, requires no card details, and carries no obligation. We use it to assess your students current level and talk through what they are aiming for. If you decide not to continue, that is the end of it.'
    },
    {
      q: 'What if my student doesn\'t connect with the tutor?',
      a: 'Tell us and we\'ll rematch you at no cost. Personality fit matters as much as credentials, and it isn\'t always right the first time. Rematching is routine and doesn\'t use up a session.'
    },
    {
      q: 'How much does online tutoring cost?',
      a: 'Rates depend on subject and level, with test preparation and advanced coursework priced above elementary and middle school support. There\'s no registration fee and no minimum contract, and lesson bundles lower the hourly rate. Full pricing is on our pricing page.'
    }
  ];
        ...
        <div className="learning-lane px-margin-mobile grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-max-width mx-auto md:px-margin-desktop">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-2 sm:-left-6 bg-white p-4 sm:p-6 rounded-2xl shadow-dropdown border border-outline-variant/30 z-20 max-w-[220px] sm:max-w-[280px] min-w-0">
              ...
              <p className="italic text-on-surface-variant text-sm break-words">"My son went from dreading math homework to explaining it to me at dinner. That shift happened in about six weeks."</p>
              <p className="mt-3 font-bold text-charcoal text-xs break-words">— Sarah J., Parent</p>
            </div>
          </div>
        </div>
      </section>
     ...
     {/* Trust Section */}
      <section className="bg-soft-gray py-12 md:py-16 border-y border-surface-container">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h5 className="text-2xl md:text-3xl font-bold text-charcoal tracking-tight">
            Recommended by parents, students, and tutors
          </h5>
          <p className="mt-4 text-base md:text-lg text-on-surface-variant leading-relaxed max-w-4xl mx-auto">
            Math Make Smart is rated 4.9 on Trustpilot, earning the trust of parents and students by
            providing the best online tutoring services worldwide. Our certified teachers ensure top-quality
            learning. Join us for proven academic success!
          </p>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="learning-lane px-margin-mobile max-w-max-width mx-auto md:px-margin-desktop">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-headline-lg md:text-display-lg-mobile font-display text-charcoal font-bold">The Ideal Tutor</h2>
            <h4>What Makes a Tutor Worth Your Time</h4>
            <p> Knowing a subject and being able to teach it are two different skills. We hire for both, then match on temperament, because the tutor who suits a confident student racing ahead is rarely the one who suits a student who has quietly stopped raising their hand.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="group flex flex-col items-center text-center p-4">
              ...
              <h3 className="text-headline-md font-display mb-3 text-charcoal font-bold">Academic Excellence</h3>
              <p className="text-body-md text-on-surface-variant leading-relaxed">
                Every tutor holds a degree in the subject they teach and is tested on the specific curriculum your child follows. We match to the standard your child is actually graded against, not a generic lesson plan.
              </p>
            </div>
            {/* Quality 2 */}
            <div className="group flex flex-col items-center text-center p-4">
              ...
              <h3 className="text-headline-md font-display mb-3 text-charcoal font-bold">Infinite Patience</h3>
              <p className="text-body-md text-on-surface-variant leading-relaxed">
                Most students who fall behind aren't stuck on this week's topic. They're missing something from two years ago. Our tutors are trained to find that gap and go back for it, however many times it takes.
              </p>
            </div>
            {/* Quality 3 */}
            <div className="group flex flex-col items-center text-center p-4">
              ...
              <h3 className="text-headline-md font-display mb-3 text-charcoal font-bold">Vetted, Safe, Accountable</h3>
              <p className="text-body-md text-on-surface-variant leading-relaxed">
                Background checks on every tutor, sessions recorded to your account, and no contact outside the platform. You can review any lesson, any time.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-soft-gray border-y border-surface-container">
        <div className="learning-lane px-margin-mobile max-w-max-width mx-auto md:px-margin-desktop">
          <div className="text-center mb-16 max-w-2xl mx-auto space-y-4">
            <h2 className="text-headline-lg md:text-display-lg-mobile font-display text-charcoal font-bold">Online Tutoring for every subject, without the hassle</h2>
            <p className="text-body-lg text-on-surface-variant">The teaching is the hard part. Everything around it, booking, rescheduling, paying, tracking progress, should take you under a minute.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              ...
              <p className="text-body-md text-on-surface-variant">See live tutor availability and book a session that fits around school, sports, and everything else. No back-and-forth email.</p>
            </div>
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              ...
              <p className="text-body-md text-on-surface-variant">Plans change. Move any session from your dashboard up to two hours ahead, at no cost and without asking permission.</p>
            </div>
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
            ...
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              ...
              <p className="text-body-md text-on-surface-variant">Every lesson is saved to your account, so your student can replay an explanation during review week and you can see exactly what was taught.</p>
            </div>
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              <Award className="w-8 h-8 text-primary mb-4" />
              <h4 className="text-headline-md font-bold mb-2 text-charcoal">No Locked Contracts</h4>
              <p className="text-body-md text-on-surface-variant">Pay as you go or choose a monthly plan. Cancel anytime, without a fee or a phone call.</p>
            </div>
            <div className="bg-white p-8 rounded-[24px] shadow-ambient hover:-translate-y-1 transition-transform duration-300 border border-surface-container">
              <Star className="w-8 h-8 text-primary mb-4" />
              <h4 className="text-headline-md font-bold mb-2 text-charcoal">Progress Reports</h4>
              <p className="text-body-md text-on-surface-variant">A written summary after every session, plus a bi-weekly report showing topics mastered and topics still needing work.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="learning-lane px-margin-mobile grid grid-cols-1 md:grid-cols-2 gap-12 max-w-max-width mx-auto md:px-margin-desktop">
          ...
          <div className="bg-surface-container-low p-10 rounded-[32px] relative overflow-hidden flex flex-col justify-between border border-surface-container">
            <div className="relative z-10">
              <h3 className="text-headline-lg font-display text-charcoal mb-4 font-semibold">Private Tutoring From Elementary Through University</h3>
              <p className="text-body-lg text-on-surface-variant mb-8 font-sans">From early number sense to university-level coursework, our tutors teach the syllabus your school actually follows. Sessions are one-on-one, so the pace is set by your student's understanding rather than by a class of thirty.</p>
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-body-md font-medium text-charcoal">Personalized learning plan after the first lesson</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-primary" />
                  <span className="text-body-md font-medium text-charcoal">Concept-first teaching, not answer-giving</span>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-primary p-6 sm:p-10 rounded-[32px] text-white relative overflow-hidden flex flex-col justify-between shadow-lg max-w-full box-border">
            <div className="relative z-10 min-w-0 max-w-full">
              <h3 className="text-headline-lg font-display mb-4 font-semibold text-white break-words">Subject Tutoring &  Test Prep in One Place</h3>
              <p className="text-body-lg text-primary-fixed-dim mb-8 break-words">Exam technique is a separate skill from knowing the material. Our test preparation tutoring covers timed practice, scoring strategy, and the exact question styles your student's exam will use. </p>
              <p>SAT · ACT · AP · GCSE · A-Levels · 11+ · 13+ · NAPLAN · NCEA</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 min-w-0 max-w-full">
                <div className="bg-white/10 p-4 rounded-xl border border-white/20 min-w-0 max-w-full overflow-hidden box-border">
                  <p className="text-[10px] font-bold opacity-80 uppercase tracking-wider min-w-0 break-words">SAT / ACT</p>
     ...
     {/* Our Global Presence */}
      <section className="py-24 bg-surface-container-lowest relative overflow-hidden border-y border-surface-container/60">
        ...
        <div className="relative z-10 max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop text-center">
          ...
          <h3 className="font-headline-lg text-headline-lg text-charcoal mb-4 font-semibold">Our Global Presence</h3>
          <h4>Tutoring Matched to Your Child's Curriculum</h4>
          <p className="text-body-lg text-on-surface-variant max-w-xl mx-auto mb-12">
            A tutor who doesn't know your exam board is a tutor learning on your time. We staff each country separately, so every student is taught by someone who knows the standards, assessment format, and grading system they'll actually face.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 sm:gap-8">
            {[
              { name: 'United Kingdom: National Curriculum, Key Stages 1–4, GCSE and A-Levels', slug: 'uk-curriculum' },
              { name: 'USA: Common Core and state standards, SAT and ACT prep', slug: 'us-curriculum' },
              { name: 'Canada: Provincial curricula, including Ontario and British Columbia', slug: 'canadian-curriculum' },
              { name: 'Australia: Australian Curriculum, NAPLAN, and Years 11–12 certificates', slug: 'australian-curriculum' },
              { name: 'New Zealand: New Zealand Curriculum and NCEA Levels 1–3', slug: 'new-zealand-curriculum' },
              { name: 'Ireland: Junior Cycle and Leaving Certificate, higher and ordinary level', slug: 'irish-curriculum' }
            ].map((country) => (
             <button
                key={country.name}
                type="button"
      ...
      <section className="py-24 bg-soft-gray border-y border-surface-container overflow-hidden">
        <div className="learning-lane px-margin-mobile max-w-max-width mx-auto md:px-margin-desktop">
          <div className="text-center mb-16">
            <h3 className="text-headline-lg md:text-display-lg-mobile font-display text-charcoal font-bold">Get Started in 3 Steps</h3>
            <h4>Getting Started Takes About Ten Minutes</h4>
          </div>
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
              <div className="text-center group">
                ...
                <p className="text-body-md text-on-surface-variant">Tell us the subject, the grade level, and what's going wrong. Pick a time that suits you. The first session costs nothing.</p>
              </div>
              <div className="text-center group">
                <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-ambient border-4 border-royal-purple group-hover:scale-110 transition-transform">
                ...
                <p className="text-body-md text-on-surface-variant">We pair your student with a specialist based on subject, curriculum, and learning style. If the fit isn't right, we'll rematch you at no charge.</p>
              </div>
              <div className="text-center group">
                <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-ambient border-4 border-royal-purple group-hover:scale-110 transition-transform">
                  <span className="text-3xl font-bold text-royal-purple">3</span>
                </div>
                <h4 className="text-headline-md font-bold mb-2 text-charcoal">Start Thriving</h4>
                <p className="text-body-md text-on-surface-variant">Sessions begin at times you choose. You'll get written progress after every lesson, and most families notice a change in confidence before they see it in grades.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="learning-lane px-margin-mobile max-w-max-width mx-auto md:px-margin-desktop">
          <div className="bg-surface-container-low rounded-[40px] p-8 md:p-16 flex flex-col lg:flex-row gap-12 items-center border border-surface-container">
            <div className="lg:w-1/2 space-y-6">
              <h2 className="text-display-lg-mobile md:text-headline-lg font-display text-charcoal font-semibold">Try a Lesson Before You Decide Anything</h2>
              <p className="text-body-lg text-on-surface-variant">Your first 30-minute session is free, and no card is required to book it. It exists so we can find out where your student actually is, and so you can watch a tutor work with them, before anyone commits to anything.</p>
...
<div className="bg-white p-6 md:p-8 rounded-[28px] shadow-[0_18px_45px_rgba(15,23,42,0.08)] border border-slate-200 w-full max-w-[520px] ml-auto relative min-h-[600px]">
  <iframe
    key={formId}
    src={`https://link.msgsndr.com/widget/form/${formId}`}
    style={{ width: '100%', height: '100%', border: 'none', borderRadius: '3px', position: 'absolute', inset: 0 }}
    id={`inline-${formId}`}
    ...
    data-form-name="Free Trial Form"
    data-height="600"
    data-layout-iframe-id={`inline-${formId}`}
    data-form-id={formId}
    title="Free Trial Form"
  />
</div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white border-t border-surface-container">
        <div className="learning-lane px-margin-mobile max-w-max-width mx-auto md:px-margin-desktop">
          <h3 className="text-headline-lg font-display text-charcoal mb-12 text-center font-bold">Frequently Asked Questions -  FAQs</h3>
