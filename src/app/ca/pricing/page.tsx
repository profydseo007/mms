...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Up to three, subject to tutor availability. Most families never reach that. If a snow day or a school trip means you need more in a particular month, message us rather than writing the sessions off.',
  },
  {
    q: 'Can one membership cover two children, or two subjects?',
    a: 'Yes, and it is the part families most often overlook when comparing online tutoring prices. A membership is a pool of lessons rather than a slot reserved for one child. Twelve lessons a month can be split between two siblings, or between one child’s math and science, at no extra cost. Where two kids each need a couple of sessions a week, one shared plan is usually cheaper than two separate ones.',
  },
  {
    q: 'Can I pause my membership?',
    a: 'Yes, at any point, with a little notice. March break, exam season and family travel all interrupt a schedule, and pausing is a routine request. Your tutor pairing is held while you are paused, so lessons pick back up with the same person instead of starting over with someone new.',
  },
  {
    q: 'Can I switch between plans?',
    a: 'Yes. Any change takes effect from your next billing date. A common pattern is starting on eight lessons a month, stepping up to twelve through the winter term ahead of exams, then dropping back once report cards are in. Moving down costs nothing and carries no penalty.',
  },
  {
    q: 'What currency is billing in, and how does it work?',
    a: 'All tutoring fees on this page are quoted in Canadian dollars (CAD). Memberships are prepaid monthly, with payment due at the start of each billing cycle. There is no registration fee, no minimum term and no charge for cancelling. Payments are processed securely, and nothing is ever added beyond the plan you selected.',
  },
  {
    q: 'Do tutors follow my province’s curriculum?',
    a: 'Yes. Tutors plan lessons around the curriculum your child is actually taught, whether that means the Ontario curriculum and EQAO expectations, British Columbia’s competency-based framework, Alberta’s program of studies ahead of Diploma Exams, or Quebec’s Programme de formation. Tell us the province and grade at booking and the first lesson is planned accordingly.',
  },
  {
    q: 'How does this compare with a local private tutor?',
    a: 'In-person tutoring in Canada typically runs $30 to $80 an hour, and rates in Toronto and Vancouver commonly sit 15 to 30 percent above that. Two things account for the gap online closes: nobody is paying for a tutor’s drive time, and there is no per-session travel premium built in. You are also not limited to whichever calculus tutor happens to live nearby.',
  },
  {
    q: 'How do I work out how many lessons my child needs?',
    a: 'Book the free trial first and let the tutor tell you. They will assess where your child sits against provincial grade expectations and say plainly what would help, which is occasionally less than a parent assumed. Choosing a plan after that conversation is far more reliable than picking one from a price list beforehand.',
  },
];

export default function PricingCanada({}: PricingProps) {
    ...
    <main className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop space-y-24 py-12">
      ...
      <section className="md:py-24 text-center">
        <h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-charcoal mb-6">
          Online Tutoring Prices for <span className="text-primary">Canadian Families</span>
        </h1>
        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto">
          One-to-one tutoring from <strong>$15 CAD a lesson</strong>, covering elementary through senior high
          school across every province. Pay as you go, or bring the cost per lesson down with a monthly
          membership. No registration fee and no contract.
        </p>
        ...
        <div className="md:col-span-4 flex flex-col">
          <div className="bg-surface-container-lowest p-8 rounded-xl pricing-card-shadow border border-outline-variant/30 flex-grow hover:-translate-y-2 transition-transform duration-300">
            ...
            <p className="text-on-surface-variant mb-8">
              No commitment. Sensible for one stubborn unit, a set of finals on the horizon, or trying a
              subject before committing to a plan.
            </p>
            <div className="space-y-6 mb-8">
              <div className="flex justify-between items-center border-b border-outline-variant pb-4">
                <span className="font-label-md text-label-md text-charcoal">Elementary (Grades 1&ndash;6)</span>
                <span className="font-headline-md text-headline-md text-primary">from $15<small className="text-body-md">/lesson</small></span>
              </div>
              <div className="flex justify-between items-center border-b border-outline-variant pb-4">
                <span className="font-label-md text-label-md text-charcoal">Middle &amp; Junior High (Grades 7&ndash;9)</span>
                <span className="font-headline-md text-headline-md text-primary">from $19<small className="text-body-md">/lesson</small></span>
              </div>
              <div className="flex justify-between items-center border-b border-outline-variant pb-4">
                <span className="font-label-md text-label-md text-charcoal">Senior High &amp; AP/IB (Grades 10&ndash;12)</span>
          ...
          <div className="mt-gutter rounded-xl overflow-hidden aspect-[1.6] relative shadow-lg">
            <img
              ...
              alt="A Canadian student working through homework at a laptop during an online tutoring session"
            />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter">
            ...
            <div className="bg-surface-container-lowest p-8 rounded-xl pricing-card-shadow border border-outline-variant/30 relative overflow-hidden hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="flex items-baseline gap-1 mb-2">
                <span className="font-display-lg text-display-lg text-charcoal">$168</span>
                <span className="text-on-surface-variant font-body-md">/month CAD</span>
              </div>
              <p className="text-primary font-label-md mb-4">Works out at $21 a lesson</p>
              <p className="text-on-surface-variant mb-8 text-sm">
                Two lessons a week. The right weight for keeping pace with class and staying ahead of
            ...
            <div className="md:flex justify-between items-start relative z-10 gap-8">
              <div className="md:w-1/2">
                ...
                <p className="text-outline-variant mb-8 text-lg">
                  ...
                  the usual route for households with more than one child, for intensive review ahead of
                  provincial exams and Diploma Exams, and for schedules that shift term by term.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    <BadgeCheck size={20} className="text-lime-green" />
                    <span>Exam-season intensives</span>
                  </div>
                </div>
              </div>
      ...
      {/* Reading a Canadian tuition quote */}
      <section className="mb-24">
        <div className="text-center mb-16">
          <h2 className="font-headline-lg text-headline-lg text-charcoal mb-4">How to Read a Canadian Tutoring Quote</h2>
          <p className="text-on-surface-variant max-w-2xl mx-auto">
            Private tutoring prices across Canada are quoted in several different ways, which makes comparing
            two providers harder than it should be. Three things account for most of the confusion.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
          <div className="bg-soft-gray p-8 rounded-xl">
            ...
            <p className="text-on-surface-variant text-sm">
              ...
              work through a full concept, short enough that focus holds, particularly for elementary-age
          ...
          <div className="bg-soft-gray p-8 rounded-xl">
            <h3 className="font-label-md text-label-md text-charcoal font-bold mb-3">Grade level, not subject</h3>
            <p className="text-on-surface-variant text-sm">
              What moves the price is grade and course difficulty rather than subject name. Grade 12 Calculus
              and Vectors costs more to staff than Grade 4 arithmetic because far fewer tutors can teach
              senior math confidently. A provider quoting one flat rate for every grade is usually cutting a
              corner somewhere.
            </p>
          </div>
          <div className="bg-soft-gray p-8 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
          <div className="md:col-span-7 space-y-6">
            ...
            <p className="text-on-surface-variant">
              The most expensive way to buy tutoring is to leave it until after a rough report card in Grade
              11. By that point there is roughly a semester left, and a semester is enough to sharpen exam
              technique but rarely enough to rebuild two years of missing foundations before university or
              college applications are due.
            </p>
            <p className="text-on-surface-variant">
              Families who start in Grade 9 or 10, or late in Grade 8, tend to need fewer lessons overall and
              spend less in total, because the work can be genuinely remedial rather than damage control. The
              same logic applies in elementary school, where a term of steady support before the jump to
              middle school is worth considerably more than a scramble once grades slip.
            </p>
            <p className="text-on-surface-variant">
              None of which means starting late is pointless. Exam technique, pacing and question-type
              familiarity all improve quickly, and that alone shifts a final grade. It simply means the
          ...
          <div className="md:col-span-5">
            <div className="bg-primary/5 border border-primary/10 rounded-xl p-8 space-y-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-on-surface-variant text-sm"><span className="font-bold text-charcoal">Grades 4&ndash;6:</span> building number sense ahead of provincial assessments such as Ontario&apos;s EQAO</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="text-lime-green shrink-0 mt-1" size={18} fill="currentColor" stroke="white" />
                <p className="text-on-surface-variant text-sm"><span className="font-bold text-charcoal">Grades 7&ndash;9:</span> shoring up middle and junior high foundations before high school math begins</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="text-lime-green shrink-0 mt-1" size={18} fill="currentColor" stroke="white" />
                <p className="text-on-surface-variant text-sm"><span className="font-bold text-charcoal">Grades 10&ndash;11:</span> course-stream decisions, credit requirements and building toward Grade 12</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="text-lime-green shrink-0 mt-1" size={18} fill="currentColor" stroke="white" />
                <p className="text-on-surface-variant text-sm"><span className="font-bold text-charcoal">Grade 12:</span> Diploma Exams, graduation assessments and university or college application requirements</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mb-24">
        <div className="text-center mb-16">
          ...
          <p className="text-on-surface-variant max-w-2xl mx-auto">
            What you pay depends on the plan you pick, not on the subject or the grade. Whichever tutoring
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
          <div className="bg-soft-gray p-8 rounded-xl flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-sm">The trial doubles as a diagnostic, establishing where your child sits against provincial grade expectations before anyone commits to anything.</p>
            </div>
          </div>
          <div className="bg-soft-gray p-8 rounded-xl flex items-start gap-4">
            <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
          ...
          <div className="bg-soft-gray p-8 rounded-xl flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-sm">Every session saved to your account, so a method can be revisited during review weeks after it was first taught.</p>
            </div>
          </div>
          <div className="bg-soft-gray p-8 rounded-xl flex items-start gap-4">
            <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-sm">Worked examples, review notes and practice questions aligned to your province&apos;s curriculum, whether that&apos;s Ontario, BC, Alberta or beyond.</p>
            </div>
          </div>
          <div className="bg-soft-gray p-8 rounded-xl flex items-start gap-4">
            <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
          ...
          <div className="bg-soft-gray p-8 rounded-xl flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-sm">Background-checked tutors, secure payments in CAD, and no contact taking place outside the platform.</p>
            </div>
          </div>
          <div className="bg-soft-gray p-8 rounded-xl flex items-start gap-4">
            <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
      ...
      <section className="mb-24">
        <div className="text-center mb-12">
          ...
          <p className="text-on-surface-variant max-w-2xl mx-auto">
            Quick answers on billing, scheduling and what a Canadian tutoring membership actually covers.
          </p>
        </div>
