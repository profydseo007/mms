...
import { Award, BookMarked, BookOpen, Calculator, CheckCircle2, ChevronDown, FunctionSquare } from 'lucide-react';
      ...
      <section className="py-24 bg-soft-gray">
        <div className="container mx-auto px-margin-mobile md:px-margin-desktop max-w-max-width">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" id="test-sections">
            {[
              { Icon: BookOpen, color: "bg-primary-fixed", iconColor: "text-royal-purple", title: "Reading & Writing", time: "Module 1", items: ["Short passages, one question each", "Craft, structure and conventions", "Same domains as the digital SAT"] },
              { Icon: BookMarked, color: "bg-lime-green/20", iconColor: "text-secondary", title: "Reading & Writing", time: "Module 2 (adaptive)", items: ["Routed by module 1 performance", "Expression of ideas", "Information and ideas"] },
              { Icon: FunctionSquare, color: "bg-secondary-container", iconColor: "text-secondary", title: "Math", time: "Module 1", items: ["Algebra and problem solving", "Calculator permitted throughout", "Built-in Desmos graphing tool"] },
              { Icon: Calculator, color: "bg-royal-purple/10", iconColor: "text-royal-purple", title: "Math", time: "Module 2 (adaptive)", items: ["Routed by module 1 performance", "Advanced maths and geometry", "Student-produced responses"] },
            ].map((section) => (
