...
const LigatureIcon = ({ name, className }: LigatureIconProps) => (
  <svg
    aria-hidden="true"
    className={className}
    viewBox="0 0 24 24"
  ...
  >
    {name === 'Clock' ? (
      ...
      <>
        <path d="M12 2v20M17 5.5C16 4.5 14.5 4 12.5 4 10 4 8 5.5 8 7.5S10 11 12.5 11s4.5 1.5 4.5 3.5-2 3.5-4.5 3.5c-2 0-3.5-.5-4.5-1.5" />
      </>
    ) : name === 'Star' ? (
...
export default function UKEnglishTutorPage({ onNavigate }: SubjectComponentProps) {
  return (
