  ...
  return (
    <div className="bg-white">
      ...
      <GradeLessonPlans
        ...
        subject="Math"
        description="Explore UK math lesson plans aligned with local year groups, courses and exams."
        plans={[
          { grade: 'Years 1–6', band: 'Primary' },
          { grade: 'Years 7–9', band: 'Key Stage 3' },
          { grade: 'GCSE Maths', band: 'GCSE' },
          { grade: 'A-level Maths', band: 'A-level' },
          { grade: 'Further Maths', band: 'A-level' },
        ]}
      />
