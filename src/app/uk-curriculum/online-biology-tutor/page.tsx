...
export default function UKBiologyTutorPage({ onNavigate }: SubjectComponentProps) {
  return (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-surface-container-low rounded-2xl p-8">
              <div className="w-12 h-12 bg-lime-green rounded-xl flex items-center justify-center mb-5">
                <span aria-hidden="true" className="text-charcoal text-xl leading-none">✓</span>
              </div>
        ...
        <div className="learning-lane max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-3"><span aria-hidden="true" className="text-royal-purple text-xl leading-none mt-0.5">✓</span><span className="text-on-surface-variant">Fully DBS-Checked &amp; Vetted Educators</span></li>
              <li className="flex items-start gap-3"><span aria-hidden="true" className="text-royal-purple text-xl leading-none mt-0.5">✓</span><span className="text-on-surface-variant">Graduates from Leading UK Universities</span></li>
              <li className="flex items-start gap-3"><span aria-hidden="true" className="text-royal-purple text-xl leading-none mt-0.5">✓</span><span className="text-on-surface-variant">Specialists in GCSE and A-Level Biology Across Every Exam Board</span></li>
            </ul>
