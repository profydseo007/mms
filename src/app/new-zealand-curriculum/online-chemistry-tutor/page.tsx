...
export default function NZChemistryTutorContent({ onNavigate }: SubjectComponentProps) {
  return (
    <div className="bg-white">
      ...
      <GradeLessonPlans
        ...
        subject="Chemistry"
        description="Explore New Zealand chemistry lesson plans aligned with local year groups, courses and exams."
        plans={[
          { grade: 'Years 9–10 Science', band: 'Junior Secondary' },
          { grade: 'NCEA Level 1 Science', band: 'NCEA' },
          { grade: 'NCEA Level 2 Chemistry', band: 'NCEA' },
          { grade: 'NCEA Level 3 Chemistry', band: 'NCEA' },
        ]}
      />
