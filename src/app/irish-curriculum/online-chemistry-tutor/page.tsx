  ...
  return (
    <div className="bg-white">
      ...
      <GradeLessonPlans
        ...
        subject="Chemistry"
        description="Explore Ireland chemistry lesson plans aligned with local year groups, courses and exams."
        plans={[
          { grade: 'Junior Cycle Science', band: 'Junior Cycle' },
          { grade: 'Leaving Cert Chemistry', band: 'Leaving Certificate' },
          { grade: 'Higher Level Chemistry', band: 'Leaving Certificate' },
        ]}
      />
