  ...
  return (
    <div className="bg-white">
      ...
      <GradeLessonPlans
        ...
        subject="English"
        description="Explore Ireland english lesson plans aligned with local year groups, courses and exams."
        plans={[
          { grade: '1st–6th Class', band: 'Primary' },
          { grade: 'Junior Cycle English', band: 'Junior Cycle' },
          { grade: 'Leaving Cert English', band: 'Leaving Certificate' },
        ]}
      />
