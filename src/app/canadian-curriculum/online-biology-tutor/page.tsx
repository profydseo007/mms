...
export default function CABiologyTutorContent({ onNavigate }: SubjectComponentProps) {
  return (
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="border border-outline-variant rounded-xl p-6">
              ...
              <ul className="space-y-1 text-sm font-medium text-charcoal border-t border-outline-variant pt-3">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Cell basics &amp; body systems</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Ecosystem fundamentals</li>
              </ul>
            </div>
            <div className="border border-outline-variant rounded-xl p-6">
              ...
              <ul className="space-y-1 text-sm font-medium text-charcoal border-t border-outline-variant pt-3">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Diversity &amp; evolution</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Genetics &amp; plant systems</li>
              </ul>
            </div>
            <div className="border border-outline-variant rounded-xl p-6">
              ...
              <ul className="space-y-1 text-sm font-medium text-charcoal border-t border-outline-variant pt-3">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Molecular genetics &amp; homeostasis</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Metabolic processes</li>
              </ul>
            </div>
            <div className="border border-outline-variant rounded-xl p-6">
              ...
              <ul className="space-y-1 text-sm font-medium text-charcoal border-t border-outline-variant pt-3">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Health science prerequisites</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-royal-purple" /> Data interpretation technique</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-royal-purple mt-0.5" />
