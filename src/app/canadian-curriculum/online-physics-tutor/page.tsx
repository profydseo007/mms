  ...
  return (
    <div className="bg-white">
      ...
      <GradeLessonPlans
        ...
        subject="Physics"
        description="Explore Canada physics lesson plans aligned with local year groups, courses and exams."
        plans={[
          { grade: 'Grades 7–8 Science', band: 'Middle School' },
          { grade: 'Grades 9–10 Science', band: 'Secondary' },
          { grade: 'SPH3U Physics', band: 'Ontario Grade 11' },
          { grade: 'SPH4U Physics', band: 'Ontario Grade 12' },
          { grade: 'Physics 20 & 30', band: 'Alberta' },
        ]}
      />
