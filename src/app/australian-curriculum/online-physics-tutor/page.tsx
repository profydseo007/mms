...
export default function AUPhysicsTutorContent({ onNavigate }: SubjectComponentProps) {
  ...
  <div className="learning-lane max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
      <div className="space-y-4">
        <h2 className="font-headline-lg text-headline-lg text-charcoal font-bold">
          Physics Lesson Plans For Each Year
        </h2>
        <p className="text-on-surface-variant max-w-xl">
          Explore Australian physics lesson plans aligned with the topics students study at each year level.
        </p>
      </div>
    </div>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
      {[
        ...
        const href = `/au/australian-curriculum/online-physics-tutor/lesson-plan-for-year-${yearWords[year]}`;
        return (
          <Link
            key={item.grade}
            href={href}
          ...
          >
            ...
            <span className="block text-sm font-semibold text-charcoal mb-1">Physics Lesson Plan For</span>
