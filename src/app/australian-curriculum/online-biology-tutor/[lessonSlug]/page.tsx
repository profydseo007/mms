...
const YEAR_SLUGS: Record<string, number> = {
  'lesson-plan-for-year-two': 2,
  'lesson-plan-for-year-three': 3,
  'lesson-plan-for-year-four': 4,
  'lesson-plan-for-year-five': 5,
  'lesson-plan-for-year-six': 6,
  'lesson-plan-for-year-seven': 7,
  'lesson-plan-for-year-eight': 8,
  'lesson-plan-for-year-nine': 9,
  'lesson-plan-for-year-ten': 10,
  'lesson-plan-for-year-eleven': 11,
  'lesson-plan-for-year-twelve': 12,
};

export default function BiologyYearLessonPlanPage() {
  const { lessonSlug } = useParams<{ lessonSlug: string }>();
  const year = YEAR_SLUGS[lessonSlug];
  if (!year) return null;
  return <CurriculumLessonPlan region="Australian" subject="Biology" year={year} />;
}