...
type LessonPlanSubject = 'Biology';
...
const TOPICS: Record<'primary' | 'middle' | 'secondary' | 'senior', string[]> = {
...
export default function YearOneBiologyLessonPlan() {
  return <CurriculumLessonPlan region="Australian" subject="Biology" year={1} />;
}
